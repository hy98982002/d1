CLAUDE-frontend-original.md 和 CLAUDE-original.md 以上两个是旧的文档，你仔细思考下按照/claude.md的宪法，考虑下还有哪些需要加入到新的 AI_EXECUTION_CONTEXT.md 里，先给我建议，2:有哪些示范代码需要单独放到单独文件，索引放到AI_exexution*.md


## 需要添加到 AI_EXECUTION_CONTEXT.md 的内容
...
1. 更新 AI_EXECUTION_CONTEXT.md，添加上述8个方面的内容
2. 创建 `docs/ai/snippets/` 目录（如果不存在）
3. 提取示范代码，创建10个独立的代码示例文件
4. 在 AI_EXECUTION_CONTEXT.md 中添加对这些代码示例文件的引用

## 预期效果

- AI_EXECUTION_CONTEXT.md 将包含更全面的工程现实和背景信息
